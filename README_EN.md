...
- **In-game composite preview (read-only)**: combines the current animation with another one into upper and lower body the way the game does (aligned at particle 8), with an upper-body twist slider (in game, up to about 37° while running and 60° while walking; unlimited while aiming, up to 180°). Particles cannot be dragged during the preview, and the edited data is untouched. The upper layer is optional: falling, dive, climbing a ladder, swimming, going/leaving prone, surrender, skydiving and wounded are played as one whole-body animation in game, and picking one of those says so.
